...
namespace CustomSupportLogger.Controllers
{
    public class CustLogInfoesController : Controller
    {
        ...
        public CustLogInfoesController(CustomerDbContext context)
        {
            _context = context;
        }
        ...
        {
            var customerDbContext = _context.CustLogInfos.Include(c => c.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CustomerDbContext.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
